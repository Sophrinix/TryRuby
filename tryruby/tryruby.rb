  ...
  class Output
    ...
    def format
      ...
      when :line_continuation
        ".." * @indent_level
      when :error
	"handleJSON({\"type\": #{@type.inspect.to_json},\"output\":#{@output.to_json}, \"result\": #{@result.inspect.to_json} })"
	...
	"handleJSON({\"type\": #{@type.inspect.to_json},\"output\":#{@output.to_json}, \"result\": #{@result.inspect.to_json} })"
	 ...
	 "handleJSON({\"type\": #{@type.to_json},\"output\":#{@output.to_json}, \"result\": #{@result.inspect.to_json} })"
